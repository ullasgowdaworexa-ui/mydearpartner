...
export const adminNavigation: AdminNavItem[] = [
  ...
  { path: '/admin/document-verifications', label: 'Document verification', shortLabel: 'Documents', description: 'Review verification documents and requests.', icon: FileCheck2, section: 'Operations', permissions: ['verification.view_all'], roles: leadership },
